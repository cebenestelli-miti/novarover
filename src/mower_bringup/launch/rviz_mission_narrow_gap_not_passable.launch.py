"""Narrow Gap Not Passable Test: RViz + mock base.

Robot starts at (0,0), waypoint at (12,0).
Two 2x2 m obstacles form a central gap that is effectively not passable for the mower.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            # Mock base: two ~2x2 m obstacles approximated as circles of radius 0.7 m
            # centered at (8, +0.9) and (8, -0.9). With radius 0.7, the inner faces
            # sit at yű0.2, leaving a narrow gap (~0.4 m) that is too small
            # for the mower + safety margin, but still appears as a tempting slot.
            Node(
                package="mower_base",
                ...
                parameters=[
                    {
                        ...
                        "virtual_obstacle_center_y": 0.9,
                        "virtual_obstacle_radius_m": 0.7,
                        "virtual_obstacle2_center_x": 8.0,
                        "virtual_obstacle2_center_y": -0.9,
                        "virtual_obstacle2_radius_m": 0.7,
