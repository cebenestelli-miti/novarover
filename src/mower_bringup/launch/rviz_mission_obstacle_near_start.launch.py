"""Obstacle Near Start Test: RViz + mock base.

Robot starts at (0,0), waypoint at (10,0).
Single 1 m cube obstacle (r=0.5 m) is placed very close in front at (1.5, 0.0).
"""
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            # Mock base: single obstacle very near the start, centered in front.
            Node(
                package="mower_base",
                ...
                parameters=[
                    {
                        ...
                        # 1.0 m cube approximated as circle of radius 0.5 m at (1.5, 0.0).
                        "virtual_obstacle_center_x": 1.5,
