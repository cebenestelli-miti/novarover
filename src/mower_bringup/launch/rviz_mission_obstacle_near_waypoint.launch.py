"""Obstacle Near Waypoint Test: RViz + mock base.

Robot starts at (0,0), waypoint at (10,0).
Single 1 m cube obstacle (r=0.5 m) is placed just before the waypoint at (9.0, 0.0).
"""
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description="Path to .waypoints mission file (default: straight 10 m line).",
            ),
            DeclareLaunchArgument(
                "farm_config",
            ...
            # Mock base: single obstacle just before the waypoint, centered on the path.
            Node(
                package="mower_base",
                ...
                parameters=[
                    {
                        ...
                        # 1.0 m cube approximated as circle of radius 0.5 m at (9.0, 0.0).
                        "virtual_obstacle_center_x": 9.0,
